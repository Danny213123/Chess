...
piece_position = {"N": knight_score, "Q": queen_score, "B": bishop_score,
            ...
            if square[1] != "K":
                if square[1] == "P":
                    ...
                    if square[1] == "N":
                        ...
                        piece_position_score = piece_position["B"][row][col]
                    elif square[1] == "R":
                        piece_position_score = piece_position["R"][row][col]
                    elif square[1] == "Q":
                        piece_position_score = piece_position["Q"][row][col]

            if square[0] == "w":
                score += score_dict[square[1]] + piece_position_score * .2
            elif square[1] == "b":
                score -= score_dict[square[1]] + piece_position_score * .2
